...
plot_df = plot_df[~plot_df['Species_Grouped'].isin(['Ascochyta phacae', 'Ramularia sp.'])]

# Plot
plt.figure(figsize=(12, 6))

# Define palette mapping
palette_map = {'Control (exclusive)':'skyblue', 'Fluconazole + Control': 'salmon'}

group1 = plot_df[plot_df['Group'] == 'Control (exclusive)']['Kill_Percent'].dropna().values
...
# Plot
order_list = ['Control (exclusive)', 'Fluconazole + Control']
