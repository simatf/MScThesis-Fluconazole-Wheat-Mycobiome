...
ax = sns.boxplot(data= richness, x= 'Treatment', y= 'isolate_richness', hue= 'Treatment', palette={"Control": "skyblue", "Fluconazole": "mediumorchid"}, legend= True)
...
### configurations
plt.ylim(bottom= 0) # top 16 when medium
