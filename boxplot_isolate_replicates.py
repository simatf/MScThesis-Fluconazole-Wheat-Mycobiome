...
# pvals = []
# for pair in pairs:
#     group1 = richness[(richness['Treatment'] == pair[0][0]) & (richness['Medium'] == pair[0][1])]['isolate_richness']
#     group2 = richness[(richness['Treatment'] == pair[1][0]) & (richness['Medium'] == pair[1][1])]['isolate_richness']
...
####annotator = Annotator(ax, pairs, data=richness, x='Treatment', y='isolate_richness', hue='Medium')
...
# add annotations
#annotator = Annotator(ax, pairs, data= richness, x= 'Replicate', y= 'isolate_richness', hue= 'Treatment')
#annotator.configure(test= 't-test_ind', text_format= 'star')  # or test='Mann-Whitney'
#annotator.apply_and_annotate()
